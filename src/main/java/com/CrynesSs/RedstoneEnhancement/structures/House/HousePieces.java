package com.CrynesSs.RedstoneEnhancement.structures.House;
...
public class HousePieces {
    ...
    private static final ResourceLocation HOUSE = new ResourceLocation(RedstoneEnhancement.MOD_ID + ":house");
    ...
    public static void start(TemplateManager templateManager, BlockPos pos, Rotation rotation, List<StructurePiece> pieceList, Random random) {
        ...
        rotationOffSet = new BlockPos(-20, 0, 0).rotate(rotation);
        blockpos = rotationOffSet.add(x, pos.getY(), z);
        pieceList.add(new HousePieces.Piece(templateManager, HOUSE, blockpos, rotation));
    }
    ...
    public static class Piece extends TemplateStructurePiece {
        ...
        public Piece(TemplateManager templateManagerIn, ResourceLocation resourceLocationIn, BlockPos pos, Rotation rotationIn) {
            super(RedstoneEnhancement.HOUSE_PIECE, 0);
        ...
        public Piece(TemplateManager templateManagerIn, CompoundNBT tagCompound) {
            super(RedstoneEnhancement.HOUSE_PIECE, tagCompound);
        ...
        protected void handleDataMarker(String function, BlockPos pos, IWorld worldIn, Random rand, MutableBoundingBox sbb) {
            ...
            if ("chest".equals(function)) {
                ...
                if (tileentity instanceof ChestTileEntity) {  // Should always be true
                    ...
                    ResourceLocation ltable = new ResourceLocation(RedstoneEnhancement.MOD_ID, "chest/house");
