...
public class InlayingMaschineTE extends InventoryTile implements IAnimatable {
    private final AnimationFactory factory = new AnimationFactory(this);

    public InlayingMaschineTE() {
        super(TileEntityTypes.INLAYING_MASCHINE.get(), 5);
    }
    ...
    private <E extends TileEntity & IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        ...
        event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.middleslot", true));
